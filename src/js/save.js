...
const CARDS_LIST = document.querySelector('.cards-list__saved');
...
// class NewsCardSave extends NewsCard {
//   createCard (cardData) {
//     super.createCard(cardData);
// }

// createCardSave () {
//   newsCard.querySelector('.card__icon').classList.remove('card__icon_bookmark');
//   newsCard.querySelector('.card__icon').classList.add('card__icon_trash');
// }
// }
...
// class NewsCardListArticle extends NewsCardList {
//   constructor(resultsContainer, articlesContainer, cardList,
//     showMoreButton, newsCard, api) {
// super(resultsContainer, articlesContainer, cardList,
//   showMoreButton, newsCard, api);
...
//   toggle(newsCard) {
//     newsCard.classList.remove('card__icon_bookmark');
//     newsCard.classList.add('card__icon_trash');
//   }
